    ...
    <div className={styles.loader_container}>
      ...
      >
        ...
        <circle
          ...
          r="100"
        ></circle>
        <circle className={styles.path} cx="103" cy="103" r="100" fill="none" stroke="#000" strokeLinecap="round" strokeWidth="6" strokeDasharray="0.001,17"/>
      </svg>
      <svg
        id="scottie-loader"
        className={styles.loader_dog}
        xmlns="http://www.w3.org/2000/svg"
